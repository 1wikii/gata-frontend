    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-500 to-blue-700 flex items-center justify-center px-4">
      <div className="flex flex-col items-center space-y-8 text-center max-w-md">
        ...
        <div className="space-y-2">
          <h1 className="text-6xl font-bold text-white/90">400</h1>
          <div className="w-16 h-1 bg-red-500 mx-auto rounded-full"></div>
        </div>

        {/* Main Message */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Token Expired!</h2>
          <p className="text-white/80 text-lg leading-relaxed">
            Silakan coba lagi dengan tautan baru.
          </p>
          <p className="text-white/60 text-sm leading-relaxed">
            Pergi ke halaman forgot password untuk mengirim ulang tautan reset
            password.
          </p>
        </div>
