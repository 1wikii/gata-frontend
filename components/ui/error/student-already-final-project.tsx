...
const StudentAlreadyFinalProject = () => {
  return (
    <div className="main-container w-4xl mx-auto flex flex-col items-center justify-center p-8">
      ...
      <h1 className="text-2xl font-bold text-gray-800 mb-4 text-center">
        Anda Sudah Mendaftar Tugas Akhir
      </h1>

      {/* Description */}
      <p className="text-gray-600 text-center mb-8 max-w-xl">
        Maaf, anda sudah terdaftar sebagai peserta tugas akhir. Silakan cek
        status pendaftaran tugas akhir anda di halaman riwayat tugas akhir.
      </p>
...
export default StudentAlreadyFinalProject;
