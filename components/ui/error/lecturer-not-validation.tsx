  ...
  return (
    <div className="main-container w-4xl mx-auto flex flex-col items-center justify-center p-8">
      ...
      <h1 className="text-2xl font-bold text-gray-800 mb-4 text-center">
        Belum ada Tugas Akhir untuk Divalidasi
      </h1>

      {/* Description */}
      <p className="text-gray-600 text-center mb-8 max-w-xl">
        Maaf, Anda belum memiliki daftar tugas akhir untuk divalidasi. Silakan
        pastikan mahasiswa telah mendaftar tugas akhir sesuai dengan persyaratan
        yang berlaku.
      </p>
...
export default LecturerNotValidation;
